...
struct fprobe {
	...
	int (*entry_handler)(struct fprobe *fp, unsigned long entry_ip, struct ftrace_regs *regs, void *entry_data);
	void (*exit_handler)(struct fprobe *fp, unsigned long entry_ip, struct ftrace_regs *regs, void *entry_data);
};
