...
typedef void (*rethook_handler_t) (struct rethook_node *, void *, struct ftrace_regs *);
...
void rethook_hook_regs(struct rethook_node *node, struct pt_regs *regs, bool mcount);
unsigned long rethook_find_ret_addr(struct task_struct *tsk, unsigned long frame,
				    struct llist_node **cur);

/* Arch dependent code must implement arch_* and trampoline code */
void arch_rethook_prepare_regs(struct rethook_node *node, struct pt_regs *regs, bool mcount);
