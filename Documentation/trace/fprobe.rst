...
.. code-block:: c
 ...
 int entry_callback(struct fprobe *fp, unsigned long entry_ip, struct ftrace_regs *regs, void *entry_data);

 void exit_callback(struct fprobe *fp, unsigned long entry_ip, struct ftrace_regs *regs, void *entry_data);
