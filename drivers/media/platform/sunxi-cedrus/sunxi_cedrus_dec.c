...
static int device_process(struct sunxi_cedrus_ctx *ctx,
			  ...
			  struct vb2_v4l2_buffer *out_vb)
{
	...
	int i;
	const struct v4l2_ctrl_ve_frame_hdr *frame_hdr = ctx->ve_frame_hdr_ctrl->p_new.p;
